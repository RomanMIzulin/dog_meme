...
friend bool operator>(const OneNote l, const OneNote r){
  ...
  //  friend bool operator>(const OneNote& l, const OneNote& r){
  //      return ((l.FIO.compare(r.FIO)>0)&&(l.nameOfStreet.compare(r.nameOfStreet)>0)&&
  //              (l.nOfBuilding>r.nOfBuilding)&&(l.nOfAppartament>r.nOfAppartament)&&
  //              (l.dateOfBirthday[2]-r.dateOfBirthday[2]>0)&&
  //              (l.dateOfBirthday[1]>r.dateOfBirthday[1])&&
  //              (l.dateOfBirthday[0]>r.dateOfBirthday[0]));
  //  }
